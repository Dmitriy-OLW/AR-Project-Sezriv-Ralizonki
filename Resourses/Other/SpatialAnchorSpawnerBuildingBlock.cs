...
namespace Meta.XR.BuildingBlocks
{
    ...
    public class SpatialAnchorSpawnerBuildingBlock : MonoBehaviour
    {
        ...
        public bool FollowHand
        {
            ...
            set
            {
                ...
                if (_followHand)
                {
                    ...
                    _anchorPrefabTransform.parent = /*_cameraRig.rightHandAnchor*/attackmentPoint;
                    _anchorPrefabTransform.localPosition = Vector3.zero + onHandAnchorOffset;
                    _anchorPrefabTransform.localRotation = /*Quaternion.identity*/rotOffset;
                }
                else
                {
                    _anchorPrefabTransform.parent = null;
                    //_anchorPrefabTransform.SetPositionAndRotation(_initialPosition, _initialRotation);
                    _anchorPrefabTransform.SetPositionAndRotation(attackmentPoint.position, attackmentPoint.rotation);
                }
            }
        }

        [SerializeField] private Vector3 onHandAnchorOffset;
        [SerializeField] private Transform attackmentPoint;
        ...
        {
            _spatialAnchorCore =
SpatialAnchorCoreBuildingBlock.GetFirstInstance();
