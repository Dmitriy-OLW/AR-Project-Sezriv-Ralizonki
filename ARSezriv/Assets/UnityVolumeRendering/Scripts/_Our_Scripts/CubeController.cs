...
public class CubeController : MonoBehaviour
{
    ...
    [SerializeField] private float sliceHeight = 0.01f;
    ...
    [SerializeField] private Button toggleSliceButton;
    ...
    private void Start()
    {
        ...
        moveXPlus.onClick.AddListener(() => MoveCube(Vector3.right));
        moveXMinus.onClick.AddListener(() => MoveCube(Vector3.left));
        moveYPlus.onClick.AddListener(() => MoveCube(Vector3.up));
        moveYMinus.onClick.AddListener(() => MoveCube(Vector3.down));
        moveZPlus.onClick.AddListener(() => MoveCube(Vector3.forward));
        moveZMinus.onClick.AddListener(() => MoveCube(Vector3.back));

        // Настройка кнопок масштабирования
        scaleXPlus.onClick.AddListener(() => ScaleCube(Vector3.right, false));
        scaleXMinus.onClick.AddListener(() => ScaleCube(Vector3.left, false));
        scaleYPlus.onClick.AddListener(() => ScaleCube(Vector3.up, false));
        scaleYMinus.onClick.AddListener(() => ScaleCube(Vector3.down, false));
        scaleZPlus.onClick.AddListener(() => ScaleCube(Vector3.forward, false));
        scaleZMinus.onClick.AddListener(() => ScaleCube(Vector3.back, false));
        scaleUniformPlus.onClick.AddListener(() => ScaleCube(Vector3.one, true));
        scaleUniformMinus.onClick.AddListener(() => ScaleCube(-Vector3.one, true));
        ...
        sliceButton.onClick.AddListener(SliceObject);
        toggleSliceButton.onClick.AddListener(OffSlice);
    }
    ...
    private void OffSlice()
    {
        Debug.Log("Отключение среза или разреза");
        // Удаление targetObj из компонента plane    
    }
