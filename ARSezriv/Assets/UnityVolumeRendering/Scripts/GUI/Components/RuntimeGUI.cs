...
namespace UnityVolumeRendering
{
    ...
    {
        public void Import_DICOM_dataset()
        {
            RuntimeFileBrowser.ShowOpenDirectoryDialog(OnOpenDICOMDatasetResultAsync);
        }

        public void Edit_imported_dataset()
        {
            if (GameObject.FindObjectOfType<VolumeRenderedObject>() != null)
            {
        ...
        private void OnGUI()
        {
            ...
            if(GUILayout.Button("Create Slicer"))
            {
