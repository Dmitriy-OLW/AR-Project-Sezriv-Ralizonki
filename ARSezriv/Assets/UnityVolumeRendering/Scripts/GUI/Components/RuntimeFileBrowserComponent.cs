...
namespace UnityVolumeRendering
{
    public partial class RuntimeFileBrowser
    {
        ...
        public class RuntimeFileBrowserComponent : MonoBehaviour
        {
            ...
            public void load_our_dataset(string _currentDirectory)
            {
                CloseBrowser(false, _currentDirectory);
            }
            public void load_our_seeting(string _selectedFile)
            {
                CloseBrowser(false, _selectedFile);
            }
